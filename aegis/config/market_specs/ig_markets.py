"""Aegis Framework - IG Markets Microstructural Specifications.

Stores hard-coded parameter rule variations for symbols mapping to IG Markets
...
IG_MARKETS_SPECIFICATIONS: dict[str, ContractSpecification] = {
    "AUDJPY": ContractSpecification(
        symbol="AUDJPY",
        base_spread_ticks=Decimal("1.2"),
